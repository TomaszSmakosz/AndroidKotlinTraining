...
class ShopProductAdapter(private val shopViewModel: ShopViewModel) : RecyclerView.Adapter<ShopProductAdapter.ProductViewHolder>() {

    private var productList: List<Product> = emptyList<Product>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.shop_product_item,
            parent, false)
